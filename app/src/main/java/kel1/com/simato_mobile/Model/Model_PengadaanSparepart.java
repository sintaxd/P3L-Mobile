...
public class Model_PengadaanSparepart {
    Integer id_supplier_fk,id_sparepartCabang_fk,satuan_pengadaan,totalHarga_pengadaan,totalBarang_datang;
    Date tgl_pengadaan, tgl_barangDatang;
    String status_pengadaan, statusCetak_pengadaan;

    public Model_PengadaanSparepart(Integer id_supplier_fk, Integer id_sparepartCabang_fk, Integer satuan_pengadaan, Integer totalHarga_pengadaan, Integer totalBarang_datang, Date tgl_pengadaan, Date tgl_barangDatang, String status_pengadaan, String statusCetak_pengadaan) {
    ...
    public Integer getTotalHarga_pengadaan() {
        return totalHarga_pengadaan;
    }

    public void setTotalHarga_pengadaan(Integer totalHarga_pengadaan) {
        this.totalHarga_pengadaan = totalHarga_pengadaan;
    }
