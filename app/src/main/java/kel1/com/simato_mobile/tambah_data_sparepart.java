...
public class tambah_data_sparepart extends AppCompatActivity {
    ...
    private TextInputLayout nama_sparepart, merk_sparepart, kode_sparepart, tipe_sparepart;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBatal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                nama_sparepart.getEditText().getText().clear();
                merk_sparepart.getEditText().getText().clear();
                tipe_sparepart.getEditText().getText().clear();
                kode_sparepart.getEditText().getText().clear();
            }
        });
    ...
    private void startIntent() {
        ...
        if (nama_sparepart.getEditText().getText().toString().isEmpty() ||
            merk_sparepart.getEditText().getText().toString().isEmpty() ||
            tipe_sparepart.getEditText().getText().toString().isEmpty() ||
            kode_sparepart.getEditText().getText().toString().isEmpty())
        {
            ...
            Call<SparepartDAO> sparepartDAOCall = apiClient.create(nama_sparepart.getEditText().getText().toString(),
                    merk_sparepart.getEditText().getText().toString(),
                    tipe_sparepart.getEditText().getText().toString(),
                    kode_sparepart.getEditText().getText().toString());
