...
//    }
    ...
    private void onClickRegister() {
                ...
                notelp_sales.getText().toString().isEmpty())
        {
            ...
            Call<Model_Supplier> supplierDAOCall = apiClientSupplier.create(nama_supp.getText().toString(),
            ...
            supplierDAOCall.enqueue(new Callback<Model_Supplier>() {
                ...
                public void onFailure(Call<Model_Supplier> call, Throwable t) {
                    Toast.makeText(tambah_data_supplier.this,  t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
